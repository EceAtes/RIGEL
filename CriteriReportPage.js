...
import { fetchCriteriReportData, fetchInternshipReportKey, sendCriteriReportData, submitCriteriReport } from './api_connection/apiConnect.js';
...
function CriteriaReportPage() {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const report= await fetchInternshipReportKey(5);
                setKey(report.reportKey);
                console.log(key);
                const data = await fetchCriteriReportData(1);
