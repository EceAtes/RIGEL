...
public class TA extends FeedbackUser{
    ...
    public TA(String name, String email, String password, boolean notificationToMail, Department department, Map<Long, Student> students) {
        super(name, email, password, notificationToMail, Role.TA, department, students);
    }
