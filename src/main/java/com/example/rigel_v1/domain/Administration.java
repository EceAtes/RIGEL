...
public class Administration extends Users{
    /*private Map<Integer, CriteriaReport> criteriaReports;
    ...
    public Administration(Map<Integer, CriteriaReport> criteriaReports, Statistics statistics, File eSignature) {
