...
const FileUpload = () => {
  ...
  const handleButtonClick = () => {
    ...
    axios.post(`http://localhost:8080/secretary/createFromFile/${id}`)
  };
...
function CustomTable (handleSave, rows){
  return (
...
function list(handleSave, rows){
  return(
  <div className="student table" style={{ width: "60vw", height: "100vh", margin: "auto", display: "flex", displayDirection: "row" }}>
          {StudentTable(rows)}
          <Button className="Submit" variant="contained" onClick={(e) => {e.preventDefault(); handleSave();}}
            sx={{
              "width": "10vw",
              "height": "8vh",
              "font-size": "20px",
...
/*
  ...
  return (
    <div className="secretaryMainPage-all-items" style={{ width: "100vw" }}>
      ...
      <h3 className="instructorMainPage-header_welcome_message" style={{
        width: "100vw",
        margin: "0px",
        textAlign: "center",
